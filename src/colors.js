...
export const sectionBgLogin = `${sectionBgBase} from-green-500 via-green-500 to-yellow-500`
export const sectionBgLoginDark = `${sectionBgBase} from-yellow-400 via-sky-700 to-green-500`
